    ...
    return [
      {
        ...
        headers: [
          ...
          { key: "Referrer-Policy", value: "strict-origin-when-cross-origin" },
          {
            ...
            value: [
              "default-src 'self'",
              "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://challenges.cloudflare.com https://www.googletagmanager.com https://translate.google.com https://translate.googleapis.com",
              ...
              "connect-src 'self' https://api.walkthroughnepal.com https://challenges.cloudflare.com https://www.googletagmanager.com https://*.google-analytics.com https://*.analytics.google.com https://translate.google.com https://translate.googleapis.com",
              "frame-src https://challenges.cloudflare.com https://translate.google.com",
              "font-src 'self'",
            ].join("; "),
          },
        ],
